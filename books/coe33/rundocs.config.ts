...
import expedition33, {
  createFormationRenderer,
  createEquipRenderer,
  createStatusRenderer,
  createSkipRenderer,
  createMenuRenderer,
} from '@rundocs/plugin-expedition33';
...
import { MENU_LABELS_JA } from './menu-labels.ja.js';
  ...
  plugin: {
    ...
    renderers: {
      html: {
        ...
        menu: createMenuRenderer(CHARACTERS_JA, MENU_LABELS_JA),
      },
    },
  },
});
